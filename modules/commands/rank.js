...
module.exports.onLoad = async function () {
  ...
  if (!existsSync(resolve(__dirname, 'cache', 'rankcard3.png'))) await downloadFile("https://i.imgur.com/y9To0p6.png", resolve(__dirname, 'cache', 'rankcard3.png'));
    if (!existsSync(resolve(__dirname, 'cache', 'rankcard4.png'))) await downloadFile("https://imgur.com/r2UxzlI.png", resolve(__dirname, 'cache', 'rankcard4.png'));
  if (!existsSync(resolve(__dirname, 'cache', 'rankcard55.png'))) await downloadFile("https://i.imgur.com/UyjwEVZ.jpg", resolve(__dirname, 'cache', 'rankcard55.png'));
