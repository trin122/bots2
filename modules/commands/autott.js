...
module.exports.onLoad = o => setInterval(async () => {
    ...
    if (á = nam.find(i => i.timer == new Date(Date.now() + 25200000).toLocaleString().split(/,/).pop().trim())) {
        ...
        msg = msg.replace(/{time}/g, require("moment-timezone").tz("Asia/Ho_Chi_Minh").format("HH:mm:ss (D/MM/YYYY) (dddd)")).replace(/{chamngon}/g, (await axios.get(`https://trinkers.glitch.me/cadao`)).data.data)
        msg = { body: msg };
